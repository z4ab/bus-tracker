...
export const PassedStopMarkerIcon = ({ label }: { label: string }) => (
  <div className="flex items-center gap-1.5" style={{ transform: "translate(-6px, -6px)" }}>
    <div className="w-3 h-3 rounded-full border-2 border-gray-400 bg-gray-100 shadow-sm flex items-center justify-center">
      <svg
    ...
    <div className="whitespace-nowrap rounded-md bg-gray-100 text-gray-500 text-xs font-semibold px-1.5 py-0.5 shadow-sm line-through">
      {label}
    </div>
  </div>
);
